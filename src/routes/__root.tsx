...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AdMark Digitals: Growth Architects" },
      {
        name: "description",
        content:
          "Research-first digital agency engineering scalable websites, SaaS, ERP and mobile platforms for startups and MSMEs.",
      },
      { name: "author", content: "AdMark Digitals" },
